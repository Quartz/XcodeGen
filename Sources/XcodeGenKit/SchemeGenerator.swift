...
public class SchemeGenerator {
    ...
    public func generateScheme(_ scheme: Scheme, for target: Target? = nil) throws -> XCScheme {
        ...
        let launchAction = XCScheme.LaunchAction(
            ...
            selectedDebuggerIdentifier: selectedDebuggerIdentifier(for: target, run: scheme.run),
            selectedLauncherIdentifier: selectedLauncherIdentifier(for: target, run: scheme.run),
            ...
            launchAutomaticallySubstyle: scheme.run?.launchAutomaticallySubstyle ?? launchAutomaticallySubstyle(for: target),
